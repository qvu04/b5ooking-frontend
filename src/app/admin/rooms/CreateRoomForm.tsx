...
export default function CreateRoomForm({ onSuccess, amenities }: Props) {
    ...
    // ✅ Xử lý chọn nhiều ảnh, không ghi đè ảnh cũ
                ...
                <div className="flex-1 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="border border-gray-300 rounded-lg px-3 py-2 w-full h-36 resize-none focus:outline-none focus:ring-2 focus:ring-[#7f5af0]"
                                ...
                                return (
                                    ...
                                    >
                                        <img
                                            src={url}
                                            alt={`preview-${index}`}
                                            className="w-full h-28 object-cover border border-gray-200"
